...
@section('title', 'Modification du nom et prenom | Etudiant')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-white"
                    ...
                    <div class="card-header text-center" style="padding: 0; margin: 0;">Formulaire de modification du
                        Nom & Prénom - Étudiant</div>
                </div>

                <div class="card-body">
                    <form action="{{route('etudiant.account.editNomPrenom', ['id'=>$users->id])}}" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nom" id="formGroupExampleInput2"
                                placeholder="nom..." value="{{old('nom', $users->nom)}}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="prenom" id="formGroupExampleInput2"
                                placeholder="prenom.." value="{{old('prenom', $users->prenom)}}">
                        </div>
