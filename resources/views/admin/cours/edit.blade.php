    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card rounded-card">
                <div class="card-header text-center">Modifier un cours</div>
                <div class="card-body">
                    <form action="{{route('admin.cours.edit',['id'=>$cours->id])}}" method="POST">
                        <div class="mb-3">
                            <label for="formGroupExampleInput2" class="form-label">Intitulé</label>
                            <input type="text" class="form-control" name="intitule" id="formGroupExampleInput2"
                                placeholder="Intitulé..." value="{{old('intitule',$cours->intitule)}}">
                        </div>
