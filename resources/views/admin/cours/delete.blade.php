...
@section('title', 'Supprimer le cours')
...
<div class="container-sm">
    ...
    <form action='{{route('admin.cours.delete',['id'=>$cours->id])}}' method="POST">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="intitule" id="formGroupExampleInput" placeholder="login..."
                value="{{old('intitule',$cours->intitule)}}">
        </div>
