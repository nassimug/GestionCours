...
@section('title', 'sélectionner un enseignant')
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card rounded-card">
                <div class="card-header text-center">Choisir un enseignant</div>
                <div class="card-body">
                    <form action="{{ route('admin.teacher.sessions', ['teacher_id' => 'PLACEHOLDER']) }}" method="get"
                        onsubmit="return setTeacherId();">
                        <div class="mb-3">
                        ...
                        <div class="mb-3 text-center">
                            <button type="submit" class="btn btn-primary">Afficher les séances</button>
                        </div>
                    </form>
                </div>
            </div>
