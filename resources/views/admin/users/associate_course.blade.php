...
@section('title', 'Associer un enseignant à un cours')
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card rounded-card">
                <div class="card-header text-center">Associer un cours à l'enseignant</div>
                <div class="card-body">
                    <h2 class="text-center">Enseignant : {{$teacher->nom}} {{$teacher->prenom}}</h2>
                    <form action="{{route('admin.users.associateCourse', ['user_id' => $teacher->id])}}" method="post">
                        @csrf
                        <div class="form-group">
                            <label for="course_id" class="mb-2">Cours</label>
                            <select class="form-select" name="course_id" id="course_id">
                                <option value="" selected disabled>--Veuillez choisir un cours--</option>
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="mb-3 text-center">
                                <button style="margin-top:20px; " type="submit"
                                    class="btn btn-primary tt">Associer</button>
                            </div>
                        </div>
                    </form>
                </div>
