...
<div class="container-sm">
    <a class="btn btn-info" href="{{route('enseignant.planning-integral')}}" style="margin-bottom: 2px;"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('enseignant.planning-integral.filter.week') }}" method="get">
                        @csrf
    ...
    <div class="modal fade" id="filterByCourseModal" tabindex="-1" aria-labelledby="filterByCourseModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('enseignant.planning-integral.filter.course') }}" method="get">
                        @csrf
